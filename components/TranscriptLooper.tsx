...
const TranscriptLooper: React.FC<TranscriptLooperProps> = ({
  ...
  const hasSummary =
    summaryMap && typeof summaryMap["2"] === "object" && summaryMap["2"] !== null && !Array.isArray(summaryMap["2"])
  ...
  return (
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="flex-grow min-h-0 pt-2 px-4 pb-4">
        {hasSummary ? (
          <TranscriptSummary ref={summaryRef} summary={summaryMap["2"]} transcript={transcript} />
        ) : (
